...
Scenario: User enables the seller shipping setting for isExcludeShippingAmount value as true
    When User is hitting seller shipping setting for isExcludeShippingAmount value as true
    Then User should get seller shipping setting status as ok in response

Scenario: User disable the seller shipping setting for isExcludeShippingAmount value as false
    When User is hitting seller shipping setting for isExcludeShippingAmount value as false
    Then User should get seller shipping setting status as ok in response

 Scenario: User provide null value for isExcludeShippingAmount in seller shipping setting
    When User is hitting seller shipping setting for isExcludeShippingAmount value as null
    Then User should get seller shipping setting status as ok in response

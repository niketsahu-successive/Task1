Feature: GQL: Allow user to fetch product report setting on marketcube platform
  ...
  Scenario: User fetches product report setting as a seller
  ...
  Scenario: User fetches product report setting as a vendor
  ...
  Scenario: User is trying to fetch product report setting as an admin
  ...
  Scenario: User is trying to fetch product report setting with an invalid token
    When User is hitting product report setting endpoint with an invalid token

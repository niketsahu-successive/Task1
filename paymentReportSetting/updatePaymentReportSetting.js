...
} = require("../../data/updatePaymentReport/updatePaymentReportSettingData");
...
module.exports = {
  paymentReportSetting: {
    ...
    input: ({
      vendorPaymentStatusHideCsv = false,
      vendorPaymentStatusHidePdf = false,
      vendorPaymentStatusLabel = "",
      vendorPaidDateHideCsv = false,
      vendorPaidDateHidePdf = false,
      vendorPaidDateLabel = "",
      sellerCommissionHideCsv = false,
      sellerCommissionHidePdf = false,

...
When("User fetches product form setting data from the database", async () => {
  ...
  productSettingData = {
    barcode       : productForm ? productForm.barcode : null,
    catalog       : productForm ? productForm.catalog : null,
    comparePrice  : productForm ? productForm.comparePrice : null,
    createdAt     : productForm ? productForm.createdAt.toISOString() : null,
    description   : productForm ? productForm.description : null,
    discount      : productForm ? productForm.discount : null, 
    inventory     : productForm ? productForm.inventory : null,
    markup        : productForm ? (productForm.markup || null) : null,
    physical      : productForm ? productForm.physical : null,
    price         : productForm ? productForm.price : null,
    productType   : productForm ? productForm.productType : null,
    quantity      : productForm ? productForm.quantity : null,
    sku           : productForm ? productForm.sku : null,
    tags          : productForm ? productForm.tags : null,
    title         : productForm ? productForm.title : null,
    wholesalePrice: productForm ? productForm.wholesalePrice : null,
